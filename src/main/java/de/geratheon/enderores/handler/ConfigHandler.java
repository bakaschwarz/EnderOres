...
public class ConfigHandler {
    ...
    private static void loadConfiguration() {
        ...
        chancesToSpawnEnderOre = config.getInt("rarityEnderOre", Configuration.CATEGORY_GENERAL, 25, 1, 100, "Sets the rarity of the ender ore. (Note: 1 is absolutely rare and 100 is absolutely common.");
